...
var elementNum = 0;
var ClassFilePathNewSet = [];
var ClassNamesNewSet = [];

while(elementNum < 36){
    let currentRandomIndex = Math.floor(Math.random() * classFilePathList.length);
    ClassFilePathNewSet.push(classFilePathList[currentRandomIndex]);
    ClassNamesNewSet.push(classNames[currentRandomIndex]);
    classNames.splice(currentRandomIndex, 1);
    classFilePathList.splice(currentRandomIndex, 1);
    ++elementNum;
}
